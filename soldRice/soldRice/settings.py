"""
Django settings for soldRice project.
...
SECRET_KEY = 'zlz=_wly=c#d=&s+qjz-o10&y!3m_9-m9!ue#43u4u%xbld(!2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['yuchun','127.0.0.1']
...
WSGI_APPLICATION = 'soldRice.wsgi.application'
